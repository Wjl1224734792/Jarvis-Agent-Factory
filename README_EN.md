...
> **v3.45.1** — 10 new commands (test suite + refactor safety net + hotfix + migration + evaluation + debug) . 5 new pipeline types . Smart MCP merge install
...
|-----------|------|-------------|
| `docs/tmp/` | All | Process temp artifacts, not versioned |
| `docs/requirements/` | Gate A | Requirement clarification |
| `docs/tasks/` | Gate B | Task breakdown |
| `docs/architecture/` | Gate B1 | Architecture review |
| `docs/plans/` | Gate C | Execution plans |
| `docs/implementation/` | Gate C-impl | Implementation docs |
| `docs/testing/` | Gate C2 | Test cases & reports |
| `docs/review/` | Gate D | Code review |
| `docs/shipping/` | Gate E | Release records & changelog |

...
export const APP_ROUTES = {
  ...
  feedHome: "/home",
  flightCircle: "/circle",
  circleDetail: "/circles/:slug",
  health: "/health",
  models: "/models",
  modelDetail: "/models/:slug",
  modelCompare: "/models/compare",
  rankings: "/rankings",
  ...
  adminAiSettings: "/admin/settings/ai"
} as const;
...
export const API_ROUTES = {
  ...
  circles: {
    ...
    create: withApiV1Prefix("/circles"),
    update: (id: string) => withApiV1Prefix(`/circles/${id}`),
    join: (id: string) => withApiV1Prefix(`/circles/${id}/join`),
    leave: (id: string) => withApiV1Prefix(`/circles/${id}/leave`),
    members: (id: string) => withApiV1Prefix(`/circles/${id}/members`),
    posts: {
      list: (circleId: string) => withApiV1Prefix(`/circles/${circleId}/posts`),
      create: (circleId: string) => withApiV1Prefix(`/circles/${circleId}/posts`),
      detail: (circleId: string, postId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}`),
      ...
      report: (circleId: string, postId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}/report`),
      update: (circleId: string, postId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}`),
      delete: (circleId: string, postId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}`),
      commentLike: (circleId: string, postId: string, commentId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}/comments/${commentId}/like`),
      commentReport: (circleId: string, postId: string, commentId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}/comments/${commentId}/report`),
      commentUpdate: (circleId: string, postId: string, commentId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}/comments/${commentId}`),
      commentDelete: (circleId: string, postId: string, commentId: string) => withApiV1Prefix(`/circles/${circleId}/posts/${postId}/comments/${commentId}`),
    },
    ...
    categoryAssignments: (categoryId: string) => withApiV1Prefix(`/circles/user-categories/${categoryId}/circles`),
  },
  adminCircles: {
    posts: withApiV1Prefix("/admin/circles/posts"),
    postStatus: (postId: string) => withApiV1Prefix(`/admin/circles/posts/${postId}/status`),
    postReports: (postId: string) => withApiV1Prefix(`/admin/circles/posts/${postId}/reports`),
    comments: withApiV1Prefix("/admin/circles/comments"),

...
async function seedAircraftCatalog() {
  ...
  await db
    ...
    .values([
      { id: MODEL_IDS.mini4, slug: "mini-4-pro", name: "DJI Mini 4 Pro", categoryId: AIRCRAFT_CATEGORY_IDS.drone, brandId: BRAND_IDS.dji, powerType: "electric", summary: "Compact and stable flight model.", description: "Suitable for travel and everyday aerial shooting.", maxFlightTimeMinutes: 45, maxRangeKilometers: 18, maxSpeedKph: 58, takeoffWeightGrams: 249, isPublished: true },
      { id: MODEL_IDS.mavic3, slug: "mavic-3-pro", name: "DJI Mavic 3 Pro", categoryId: AIRCRAFT_CATEGORY_IDS.drone, brandId: BRAND_IDS.dji, powerType: "electric", summary: "Multi-lens flagship for commercial workflows.", description: "High-end model for demanding image capture.", maxFlightTimeMinutes: 43, maxRangeKilometers: 28, maxSpeedKph: 75, takeoffWeightGrams: 958, isPublished: true },
      { id: MODEL_IDS.autelLite, slug: "evo-lite-plus", name: "Autel EVO Lite+", categoryId: AIRCRAFT_CATEGORY_IDS.drone, brandId: BRAND_IDS.autel, powerType: "electric", summary: "Balanced image quality and endurance.", description: "Good low-light and stable handling.", maxFlightTimeMinutes: 40, maxRangeKilometers: 24, maxSpeedKph: 68, takeoffWeightGrams: 835, isPublished: true },
      { id: MODEL_IDS.eh216, slug: "eh216-s", name: "EHang EH216-S", categoryId: AIRCRAFT_CATEGORY_IDS.evtol, brandId: BRAND_IDS.ehang, powerType: "electric", summary: "Representative urban eVTOL sample.", description: "Used as low-altitude mobility benchmark data.", maxFlightTimeMinutes: 25, maxRangeKilometers: 35, maxSpeedKph: 130, takeoffWeightGrams: null, isPublished: true },
      { id: MODEL_IDS.jobyS4, slug: "joby-s4", name: "Joby S4", categoryId: AIRCRAFT_CATEGORY_IDS.evtol, brandId: BRAND_IDS.joby, powerType: "electric", summary: "Commercial-route eVTOL reference.", description: "Long-term tracking target for eVTOL progress.", maxFlightTimeMinutes: 45, maxRangeKilometers: 240, maxSpeedKph: 320, takeoffWeightGrams: null, isPublished: true },
      { id: MODEL_IDS.visionJet, slug: "vision-jet-g2-plus", name: "Cirrus Vision Jet G2+", categoryId: AIRCRAFT_CATEGORY_IDS.businessJet, brandId: BRAND_IDS.cirrus, powerType: "fuel", summary: "General aviation personal jet sample.", description: "Cross-category baseline for low-altitude transport.", maxFlightTimeMinutes: 300, maxRangeKilometers: 2300, maxSpeedKph: 576, takeoffWeightGrams: null, isPublished: true }
    ])
    .onConflictDoNothing();
}

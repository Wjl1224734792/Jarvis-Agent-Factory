...
async function seedPosts(adminUserId: string) {
  await db
    ...
    .values([
      ...
      { id: POST_IDS.coastMoment, authorId: USER_IDS.canyon, type: "moment", title: "Coastline test log", content: "Wind was stronger than expected but return-to-home stayed stable.", contentHtml: null, contentPlainText: "Wind was stronger than expected but return-to-home stayed stable.", coverImageFileId: null, contentCategoryId: null, status: "published", commentCount: 0, reportCount: 0, likeCount: 2, favoriteCount: 1, shareCount: 0, createdAt: seededDate(25, 6), updatedAt: seededDate(25, 6), publishedAt: seededDate(25, 6) },
      { id: POST_IDS.valleyMoment, authorId: USER_IDS.review, type: "moment", title: "Valley wind note", content: "Reserve extra height before final descent in crosswind valleys.", contentHtml: null, contentPlainText: "Reserve extra height before final descent in crosswind valleys.", coverImageFileId: null, contentCategoryId: null, status: "published", commentCount: 1, reportCount: 0, likeCount: 1, favoriteCount: 0, shareCount: 0, createdAt: seededDate(24, 14), updatedAt: seededDate(24, 14), publishedAt: seededDate(24, 14) },
      { id: POST_IDS.hiddenMoment, authorId: USER_IDS.night, type: "moment", title: "Hidden sample moment", content: "Hidden sample moment for moderation history.", contentHtml: null, contentPlainText: "Hidden sample moment for moderation history.", coverImageFileId: null, contentCategoryId: null, status: "hidden", commentCount: 0, reportCount: 1, likeCount: 0, favoriteCount: 0, shareCount: 0, createdAt: seededDate(23, 18), updatedAt: seededDate(23, 18), publishedAt: seededDate(23, 18) }
    ])
    .onConflictDoNothing();
}

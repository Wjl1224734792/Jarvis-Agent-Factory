...
model: inherit
argument-hint: [审查范围]
tools: ["Read", "Glob", "Grep", "Bash", "WebFetch", "WebSearch", "Skill", "Agent", "Edit", "Write", "mcp__jarvis-engine__session_join", "mcp__jarvis-engine__gate_jump", "mcp__jarvis-engine__pipeline_guide", "mcp__jarvis-engine__gate_check", "mcp__jarvis-engine__advance_gate", "mcp__jarvis-engine__gate_enforce", "mcp__jarvis-engine__report_status"]
---

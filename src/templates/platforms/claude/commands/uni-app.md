...
- `code-explore-expert`：项目全景——技术栈、目录结构、已有 uni-app 页面/组件、pages.json 配置、平台适配代码、条件编译
- `external-resource-expert`：uni-app 官方文档最新版、小程序/H5/App API 变更、跨端兼容性最佳实践
...
spawn `code-explore-expert` + `external-resource-expert`（spawn 前 `gate_check("read")`）：
- `code-explore-expert`：需求涉及的特定页面/组件、相关代码路径、依赖链路、可复用模块、平台差异代码
- `external-resource-expert`：需求相关的 uni-app API 文档、多端兼容性（小程序/H5/App）、技术方案参考

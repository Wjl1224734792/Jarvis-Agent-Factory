...
- `code-explore-expert`：项目全景——技术栈、目录结构、已有 Taro 页面/组件、路由配置、平台适配代码、条件编译
- `external-resource-expert`：Taro 框架最新版本、小程序 API 变更、H5 兼容性、跨端最佳实践
...
- `external-resource-expert`：需求相关的 Taro API 文档、小程序/H5 双端兼容性、技术方案参考

...
- `code-explore-expert`：项目全景——技术栈、目录结构、已有 React 页面/组件、路由配置、状态管理模式
- `external-resource-expert`：React 18/19 新特性（Server Components/Actions）、相关库最新版本与最佳实践
...
spawn `code-explore-expert` + `external-resource-expert`（spawn 前 `gate_check("read")`）：
- `code-explore-expert`：需求涉及的特定组件、相关代码路径、依赖链路、可复用 Hooks/组件
- `external-resource-expert`：需求相关的 React API 文档、兼容性注意事项、技术方案参考

...
4. 审查流程：
   ...
   - 可并发调用 `project-review-expert`、`diff-review-expert`、`perf-review-expert`、`frontend-architect`、`backend-architect`、`database-architect`、`code-explore-expert` 等只读 Agent

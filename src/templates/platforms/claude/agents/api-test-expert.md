...
2. API 契约文档（如有 `.jarvis/YYYY-MM-DD/api/` 下的 OpenAPI/Swagger 文件）
3. 实现阶段的需求文档（`.jarvis/YYYY-MM-DD/requirements/`）
...
## 输出格式
输出到 `.jarvis/YYYY-MM-DD/testing/<topic>-api-test-results.md`

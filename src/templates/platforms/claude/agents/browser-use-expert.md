...
```
# 截图保存初始状态
browser-use screenshot docs/tmp/screenshots/<page>-initial.png
...
# 页面状态验证
browser-use screenshot docs/tmp/screenshots/<page>-after-action.png
...
```
# 视觉异常
browser-use screenshot docs/tmp/screenshots/<page>-anomaly.png
...
browser-use screenshot docs/tmp/screenshots/flow-step2.png
```

### 步骤 7：输出探索报告

输出探索报告到 `docs/<YYYY>-<MM>-<DD>/browser-use/report.md`，包含：

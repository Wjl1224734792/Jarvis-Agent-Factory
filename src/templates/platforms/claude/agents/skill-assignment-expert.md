...
2. 读取 Gate B 产出的任务文档（`docs/<YYYY>-<MM>-<DD>/tasks/` 下的任务文档）
3. 读取 Gate C 产出的规划文档（`docs/<YYYY>-<MM>-<DD>/plans/` 下的规划文档）
...
2. **任务文档路径**：`docs/<YYYY>-<MM>-<DD>/tasks/<topic>-tasks.md`
3. **规划文档路径**：`docs/<YYYY>-<MM>-<DD>/plans/<topic>-plan.md`

## 输出规范

路径：`docs/<YYYY>-<MM>-<DD>/skills/skill-assignment.md`
...
- [ ] 每个技能均来自编排者传入的可用技能清单
- [ ] 分配逻辑符合本模板定义的规则
- [ ] 技能分配文档已写入 `docs/<YYYY>-<MM>-<DD>/skills/skill-assignment.md`

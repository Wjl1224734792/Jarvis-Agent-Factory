...
tools: Read, Write, Edit, Bash, Glob, Grep, Skill, mcp__jarvis-engine__jarvis_priority_context, mcp__jarvis-engine__jarvis_priority_context, mcp__jarvis-engine__jarvis_ast_search

...
description: "Use this agent when you need backend server business logic. Typical triggers include domain logic, state machines, permission validation, idempotency, and workflow orchestration."
...
路径：.jarvis/YYYY-MM-DD/implementation/<topic>-service-implementation.md

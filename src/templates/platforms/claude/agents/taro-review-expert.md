...
description: "Use this agent when you need Taro mini-program/H5 code review. Typical triggers include component architecture review, UI implementation audit, state management inspection, and performance optimization review."

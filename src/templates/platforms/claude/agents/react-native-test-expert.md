...
description: "Use this agent when you need React Native/Expo cross-platform testing. Typical triggers include unit tests, component tests, integration tests, and test coverage improvement."

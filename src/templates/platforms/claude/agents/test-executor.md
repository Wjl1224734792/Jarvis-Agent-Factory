...
## 核心约束（红线）
- **绝对不自行编写测试用例**——只执行 `docs/YYYY-MM-DD/testing/` 下已有文档中的用例
- **不修改测试步骤**——完全按照文档中的操作步骤执行
- **不创造新的测试场景**——即使发现遗漏，也只记录不扩展

## 输入
1. 测试用例文档：`docs/YYYY-MM-DD/testing/<topic>-test-cases.md`
2. 前端变更文件列表（用于定位验证目标）
...
## 输出格式
输出到 `docs/YYYY-MM-DD/testing/<topic>-test-results.md`

...
description: "Use this agent when you need Flutter/Dart cross-platform code review. Typical triggers include component architecture review, UI implementation audit, state management inspection, and performance optimization review."

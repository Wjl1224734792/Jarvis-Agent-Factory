...
function installHooks(platform: string, target: string, isGlobal: boolean, force: boolean) {
  ...
  const hookJson = {
    PreToolUse: [
      ...
      // Bash write bypass prevention: catch dangerous file-write patterns
      { matcher: 'Bash(echo * > *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(printf * > *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(cat > *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(tee *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(dd *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(python -c *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(python3 -c *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(ruby -e *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(perl -e *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(bash -c *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(sh -c *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(powershell *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(cmd /c *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(sed -i *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(* >> *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(curl * > *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(wget * -O *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(rm *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(rm -rf *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(mv *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(curl * | bash)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(curl * | sh)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(wget * | bash)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(node -e *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(npm install *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(npm run *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(yarn add *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(yarn *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(pip install *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(git reset *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(git checkout *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(chmod *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(docker *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(ssh *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
      { matcher: 'Bash(scp *)', hooks: [{ type: 'command', command: 'jarvis hook gate-check --operation write_code' }] },
    ],

...
export const GATE_CONFIG: Record<string, GateConfig> = {
  ...
  'R2': { dir: 'refactoring',  check: '现有测试套件全部通过，基线覆盖率报告已产出',                                                                              operations: { allow: ['read','spawn_test'],                            deny: ['write_code','spawn_impl','build','deploy'] },                agent_guide: { can_spawn: ['frontend-test-expert','backend-test-expert','android-test-expert', 'ios-test-expert', 'flutter-test-expert', 'taro-test-expert', 'react-native-test-expert', 'expo-test-expert'], note: '运行现有测试套件+基线覆盖率', team_strategy: 'subagent_only' },                                                                                                                                                    max_retry: 2, entry_condition: 'Gate R1 重构边界已确认' },
  'R3': { dir: 'refactoring',  check: '重构代码已提交，所有修改在重构边界内，未涉及边界外文件',                                                                  operations: { allow: ['read','write_code','spawn_impl'],              deny: ['spawn_test','build','deploy'] },                              agent_guide: { can_spawn: ['frontend-dev-expert','frontend-ui-expert','frontend-state-expert','backend-dev-expert','backend-api-expert','backend-logic-expert','backend-data-expert','android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert','remediation-expert'], note: '执行重构——推荐 Agent Team 并行执行,各成员独占模块', team_strategy: 'prefer_team', team_rules: '重构按模块拆分,每个Team成员独占一个模块,共享区域由唯一责任人处理' }, max_retry: 2, entry_condition: 'Gate R2 基线测试通过+覆盖率已记录' },
  'R4': { dir: 'refactoring',  check: '测试套件再次全部通过，覆盖率对比无下降，行为漂移检测通过',                                                                operations: { allow: ['read','spawn_test'],                            deny: ['write_code','spawn_impl','build','deploy'] },                agent_guide: { can_spawn: ['frontend-test-expert','backend-test-expert','android-test-expert', 'ios-test-expert', 'flutter-test-expert', 'taro-test-expert', 'react-native-test-expert', 'expo-test-expert'], note: '再次运行测试+对比覆盖率+行为漂移检测, 可并行执行前后端测试', team_strategy: 'prefer_team', team_rules: '前端测试和后端测试各自独占,互不干扰,结果汇总对比' },                                                                      max_retry: 2, entry_condition: 'Gate R3 重构代码已提交' },
  ...
  'H1': { dir: 'hotfix', check: '最小化修复代码已提交，修复范围严格限定在故障根因，未夹带无关改动',                  operations: { allow: ['read','write_code','spawn_impl'],              deny: ['spawn_test','build','deploy'] },                              agent_guide: { can_spawn: ['frontend-dev-expert','backend-dev-expert','android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert','remediation-expert'], note: '最小化修复' },                                                                                                                                                                          max_retry: 2, entry_condition: 'Gate H0 审批人已确认' },
  'H2': { dir: 'hotfix', check: '快速验证通过（Lint+Type-check+Build+Test重检），修复后功能正常，回滚预案可执行',      operations: { allow: ['read','spawn_test','fix'],                     deny: ['write_code','spawn_impl','build','deploy'] },                agent_guide: { can_spawn: ['frontend-test-expert','backend-test-expert','browser-test-expert','android-test-expert', 'ios-test-expert', 'flutter-test-expert', 'taro-test-expert', 'react-native-test-expert', 'expo-test-expert'], note: '快速验证+回滚预案' },                                                                                                                                                              max_retry: 2, entry_condition: 'Gate H1 最小化修复已提交' },
  ...
  'E1': { dir: 'evaluation',  check: '快速原型已生成（沙箱/独立分支），可独立运行',                                   operations: { allow: ['read','write_code','spawn_impl'],              deny: ['spawn_test','build','deploy'] },                              agent_guide: { can_spawn: ['frontend-dev-expert','backend-dev-expert','android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert'], note: '生成快速原型（沙箱）' },                                                                                                                                                                                          max_retry: 2, entry_condition: 'Gate E0 评估标准已定义' },
  'E2': { dir: 'evaluation',  check: '评估用例全部运行完毕，指标数据已收集',                                        operations: { allow: ['read','spawn_test'],                            deny: ['write_code','spawn_impl','build','deploy'] },                agent_guide: { can_spawn: ['frontend-test-expert','backend-test-expert','perf-test-expert','android-test-expert', 'ios-test-expert', 'flutter-test-expert', 'taro-test-expert', 'react-native-test-expert', 'expo-test-expert'], note: '运行用例+收集指标' },                                                                                                                                                                    max_retry: 2, entry_condition: 'Gate E1 原型已生成' },
  ...
  'D1': { dir: 'debug',       check: '最小复现用例已生成，可稳定复现异常',                                          operations: { allow: ['read','write_code','spawn_impl'],              deny: ['spawn_test','build','deploy'] },                              agent_guide: { can_spawn: ['frontend-dev-expert','backend-dev-expert','android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert'], note: '生成最小复现用例' },                                                                                                                                                                                          max_retry: 2, entry_condition: 'Gate D0 异常信息已收集' },
  'D2': { dir: 'debug',       check: '调试会话已启动，断点/日志已插入关键路径',                                       operations: { allow: ['read','write_code','spawn_impl'],              deny: ['spawn_test','build','deploy'] },                              agent_guide: { can_spawn: ['frontend-dev-expert','backend-dev-expert','android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert'], note: '启动调试会话' },                                                                                                                                                                                              max_retry: 2, entry_condition: 'Gate D1 复现用例已生成' },
  'D3': { dir: 'debug',       check: '交互式诊断完成，根因已定位',                                                operations: { allow: ['read','write_code','spawn_impl','spawn_test'], deny: ['build','deploy'] },                                         agent_guide: { can_spawn: ['frontend-dev-expert','backend-dev-expert','android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert'], note: '交互式诊断' },                                                                                                                                                                                                  max_retry: Infinity, entry_condition: 'Gate D2 调试会话已启动' },
  ...
  'S1': { dir: 'simplification', check: '简化执行完成，代码已按分析报告优化，所有功能保持不变',                              operations: { allow: ['read','write_code','spawn_impl'],              deny: ['spawn_test','build','deploy'] },                              agent_guide: { can_spawn: ['frontend-dev-expert', 'backend-dev-expert', 'backend-logic-expert', 'android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert', 'remediation-expert'], note: '简化执行——推荐 Agent Team 按模块并行简化，各成员独占文件区域，确保功能不变', team_strategy: 'prefer_team', team_rules: '每个Team成员独占模块/文件区域,禁止多成员共享同一文件。前端按组件拆分,后端按服务模块拆分。只做删除冗余+提取复用+简化逻辑,不改变功能行为' }, max_retry: 2, entry_condition: 'Gate S0 代码分析报告已产出' },
  'S2': { dir: 'simplification', check: '回归验证通过：Lint+Type-check+Build+Test全部通过，无回归',                    operations: { allow: ['read','lint','build','spawn_test','fix'],      deny: ['write_code','spawn_impl','deploy'] },                         agent_guide: { can_spawn: ['frontend-test-expert', 'backend-test-expert', 'android-test-expert', 'ios-test-expert', 'flutter-test-expert', 'taro-test-expert', 'react-native-test-expert', 'expo-test-expert'], note: '回归验证——Lint+Type-check+Build+Test全跑，确保简化无回归', team_strategy: 'subagent_only' },                                                                                                                                      max_retry: 3, entry_condition: 'Gate S1 简化执行已完成' },
  ...
  'IM3': { dir: 'improvement', check: '改进已执行，基准测试已运行，结果已记录',                                    operations: { allow: ['read','write_code','spawn_impl','lint','build','spawn_test','fix'], deny: ['deploy'] }, agent_guide: { can_spawn: ['frontend-dev-expert', 'backend-dev-expert', 'backend-logic-expert', 'android-dev-expert', 'ios-dev-expert', 'flutter-dev-expert', 'taro-dev-expert', 'react-native-dev-expert', 'expo-dev-expert', 'remediation-expert', 'frontend-test-expert', 'backend-test-expert', 'android-test-expert', 'ios-test-expert', 'flutter-test-expert', 'taro-test-expert', 'react-native-test-expert', 'expo-test-expert'], note: '执行验证——推荐 Agent Team 并行实现改进+运行基准测试，各成员独占模块', team_strategy: 'prefer_team', team_rules: '每个Team成员独占模块/文件区域,禁止多成员共享同一文件。实现和测试Agent各自独立,测试确认改进效果' }, max_retry: 3, entry_condition: 'Gate IM2 改进计划已制定' },

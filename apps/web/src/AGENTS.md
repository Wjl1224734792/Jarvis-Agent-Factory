...
| features/ | Project subdirectory | [AGENTS.md](features/AGENTS.md) |
| hooks/ | React hooks | [AGENTS.md](hooks/AGENTS.md) |
| lib/ | Library code | [AGENTS.md](lib/AGENTS.md) |
| routes/ | Route handlers | [AGENTS.md](routes/AGENTS.md) |
| store/ | Project subdirectory | [AGENTS.md](store/AGENTS.md) |
...
## Dependencies
- **Internal:** components/, features/, hooks/, lib/, routes/, store/

...
## Purpose
This directory contains the admin-analytics module of the project.

## Key Files
| File | Description |
|------|-------------|
| admin-analytics.route.ts | TypeScript source |
| admin-analytics.service.ts | TypeScript source |

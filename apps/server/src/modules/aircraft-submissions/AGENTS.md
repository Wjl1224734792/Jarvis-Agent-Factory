...
## Purpose
This directory contains the aircraft-submissions module of the project.

## Key Files
| File | Description |
|------|-------------|
| AGENTS.md | Markdown documentation |
| aircraft-submissions.repo.ts | TypeScript source |
| aircraft-submissions.route.ts | TypeScript source |
| aircraft-submissions.service.ts | TypeScript source |

...
## Purpose
This directory contains the reviews module of the project.
...
| reviews.repo.ts | TypeScript source |
| reviews.route.ts | TypeScript source |
| reviews.service.ts | TypeScript source |

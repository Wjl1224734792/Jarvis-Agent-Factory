...
> **需求文档**: `.jarvis/requirements/REQ-commands-subagent-integration.md`
> **DDD 分析**: `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md`
> **BDD 场景**: `.jarvis/2026-05-18/tasks/commands-subagent-integration-bdd.md`（覆盖 REQ-001/REQ-002）
> **任务文档**: `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md`
> **计划日期**: 2026-05-18
> **计划版本**: v1.0
...
- 不修改清理策略逻辑
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-010)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.10)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-010)
### allowed_paths:
...
- 不修改覆盖率门禁标准
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-011)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.11)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-011)
### allowed_paths:
...
- 不修改契约格式标准
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-012)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.12)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-012)
### allowed_paths:
...
- 不添加浏览器操作到编排者范围
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-013)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.13)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-013)
### allowed_paths:
...
- 不添加新的性能测试工具
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-014)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.14)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-014)
### allowed_paths:
...
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-015)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.15)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-015)
### allowed_paths:
...
- 不修改 Bug Report 格式
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-003)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.3)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-003)
### allowed_paths:
...
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-005)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.5)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-005)
### allowed_paths:
...
- 不添加新的评估维度
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-006)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.6)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-006)
### allowed_paths:
...
- 不修改回滚预演逻辑
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-007)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.7)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-007)
### allowed_paths:
...
- 不修改不变行为清单格式
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-004)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.4)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-004)
### allowed_paths:
...
- 不修改迁移不夹带业务逻辑修改的红线
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-008)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.8)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-008)
### allowed_paths:
...
- 不修改 Gate D 序列定义
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-001)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.1)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-bdd.md` (S1~S4)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-001)
### allowed_paths:
...
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-002)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.2)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-bdd.md` (S5~S10)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-002)
### allowed_paths:
...
- 不修改环境检测逻辑
### input_documents:
- `.jarvis/requirements/REQ-commands-subagent-integration.md` (REQ-009)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-ddd.md` (Section 6.9)
- `.jarvis/2026-05-18/tasks/commands-subagent-integration-tasks.md` (TASK-009)
### allowed_paths:

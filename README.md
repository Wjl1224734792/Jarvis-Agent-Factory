...
> **当前版本** — Claude Code 47 智能体 + 15 命令，OpenCode 48 智能体 + 15 命令，Codex 45 智能体。跨平台共享 27 个方法论技能（Codex 29 含审查技能）。已集成 browser-use 浏览器自动化测试与 Bug 复现闭环。
...
48 智能体 + 15 命令，镜像 `.claude/commands/`。
...
> Claude Code 中 jarvis 为命令（`.claude/commands/jarvis.md`），OpenCode 中为 Agent。Codex 审查流程以技能实现。

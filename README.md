...
[![Version](https://img.shields.io/badge/version-v4.3.6-green)](https://github.com/Wjl1224734792/Jarvis-Agent-Factory/releases)
...
> **v4.3.6** — 审查体系深度优化：参考 OMC 增加置信度维度、多视角审查、自查校验、发现/过滤分离、对抗升级模式

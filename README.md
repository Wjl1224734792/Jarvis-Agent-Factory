...
| 项目介绍 | `/commands` | 项目概览 · 32条指令流程详解 · 71个Agent目录 · 流水线架构 · 使用推荐 |
...
每个 Claude Code 命令的完整介绍，包含项目概览、32条指令的详细流程（含 Gate 序列和 Agent spawn 关系）、71个智能体目录、流水线架构和使用推荐。启动引擎后访问 `/commands` 查看项目介绍与指令参考。
